...
<head>
<meta charset="utf-8">
<link rel="stylesheet" type="text/css" href="css/phase06/p6_555/Application.css">
<title>555IC timer circuit industry</title>
</head>

<body bgcolor="#CCCC99" id="main">
<div id="text">
<h2 id= "information">You have 100 units of 555IC Timer. Mouse over to each industry on the map to indicate the quantity of 555IC Timer you would like to sell. You must sell all 100 units to proceed.</h2></br>

<button type="button" id="endbutton" onclick="location='finalassessment.html'">End</button>
...
function drawChart() {
        ...
        var options = {
          title: 'Revenue Distribution for 555IC Timer circuit.',
...
function resell(){
	...
	document.getElementById('information').innerHTML = "You have 100 units of 555IC Timer. Mouse over to each industry on the map to indicate the quantity of 555IC Timer you would like to sell. You must sell all 100 units to proceed.</h2></br>";
}
</script>
