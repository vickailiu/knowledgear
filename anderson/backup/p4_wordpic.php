...
<a href="p4_mcq.html">
<img src="images/phase04/wordpic/buttons/a4_nextButton.jpg" id="yourImgId" alt="Next" align="right" width="0" height="0"/></a>
<style>
table, td {
...
function getCurrentHTMLPage(){
	...
	// split() seperate the string if '/' is detect,
	// 	then store the splited strings as array
...
function loadImages(imgArr){
	...
	setTimeout(function(){
		loadImages(words)
	},1500); // call function every 1.5 sec
	return true;
}// End loadImages
